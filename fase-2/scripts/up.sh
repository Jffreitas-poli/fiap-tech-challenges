...
echo "== flags-service =="
apply "$ROOT_DIR/flags-service/k8s/secrets.yaml"
apply "$ROOT_DIR/flags-service/k8s/configmap.yaml"
apply "$ROOT_DIR/flags-service/k8s/deployment.yaml"
apply "$ROOT_DIR/flags-service/k8s/service.yaml"
