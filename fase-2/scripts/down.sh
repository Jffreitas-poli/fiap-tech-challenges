...
echo "== flags-service =="
delete "$ROOT_DIR/flags-service/k8s/service.yaml"
delete "$ROOT_DIR/flags-service/k8s/deployment.yaml"
delete "$ROOT_DIR/flags-service/k8s/configmap.yaml"
delete "$ROOT_DIR/flags-service/k8s/secrets.yaml"
